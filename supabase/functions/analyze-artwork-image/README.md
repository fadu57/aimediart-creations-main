...
3. Sinon ligne **`prompt_style`** dont un libellé **`name_*`** correspond à « Analyse de l'image » (concaténation `style_rules` + `system_instruction`). `max_tokens` pilote la sortie Gemini (256–4096).
