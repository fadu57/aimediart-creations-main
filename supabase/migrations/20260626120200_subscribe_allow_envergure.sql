-- ENVERGURE devient souscriptible en self-service (comme ATELIER / HORIZON).
-- Recréation de subscribe_organisation_plan avec ENVERGURE dans les listes autorisées.
BEGIN;
