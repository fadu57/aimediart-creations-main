...
export function TtsPlayButton({ isPlaying, onPress, supported }: TtsPlayButtonProps) {
  ...
  return (
    <button
      type="button"
      onClick={onPress}
      aria-label={isPlaying ? t("tts_stop_aria") : t("tts_play_aria")}
      aria-pressed={isPlaying}
      title={isPlaying ? t("tts_stop") : t("tts_play")}
      className={[
    ...
    >
      ...
      <span aria-hidden className="leading-none">
        {isPlaying ? t("tts_stop") : t("tts_play")}
      </span>
    </button>
  );
}
