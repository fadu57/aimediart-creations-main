...
function CgvI18nFullDocument() {
  ...
  return (
    <>
      ...
      <div className={LEGAL_ARTICLE_CLASS}>
        <CgvI18nBody />
      </div>
    </>
  );
...
/** Page publique CGV — édition juriste / admin 1 via LegalEditablePage. */
const CgvPage = () => (
  <LegalEditablePage slug="cgv" contentNamespace="cgv" i18nFallback={<CgvI18nFullDocument />} />
);
