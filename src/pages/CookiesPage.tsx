    ...
    <PublicVitrineShell vitrinePathPrefix="/organisation" atmosphericBackdrop>
      <main className="mx-auto w-full max-w-[1060px] bg-[var(--tw-ring-offset-color)] px-5 pb-10 pt-24 sm:px-6">
        <div className="rounded-2xl border border-[rgba(0,166,255,0.35)] bg-white px-5 py-8 shadow-[0_16px_48px_rgba(30,64,175,0.09)] backdrop-blur-xl sm:px-8 sm:py-10">
          ...
          <section className="mb-10">
            <h2 className="!text-[12px] !font-black text-[#1f1f1f]">{bt("sections.whatIsCookie.title")}</h2>
            <p className="mt-3">{bt("sections.whatIsCookie.p1")}</p>
            <p className="mt-3">{bt("sections.whatIsCookie.p2")}</p>
          </section>

          <section className="mb-10">
            <h2 className="!text-[12px] !font-black text-[#1f1f1f]">{bt("sections.whoResponsible.title")}</h2>
          ...
          <section className="mb-10">
            <h2 className="!text-[12px] !font-black text-[#1f1f1f]">{bt("sections.types.title")}</h2>

            <div className="mt-6">
              <h3 className="!text-[12px] italic text-[#1f1f1f]">{bt("sections.types.necessary.title")}</h3>
            ...
            <div className="mt-8">
              <h3 className="!text-[12px] italic text-[#1f1f1f]">{bt("sections.types.analytics.title")}</h3>
          ...
          <section className="mb-10">
            <h2 className="!text-[12px] !font-black text-[#1f1f1f]">{bt("sections.noAds.title")}</h2>
          ...
          <section className="mb-10">
            <h2 className="!text-[12px] !font-black text-[#1f1f1f]">{bt("sections.cmp.title")}</h2>
          ...
          <section className="mb-10">
            <h2 className="!text-[12px] !font-black text-[#1f1f1f]">{bt("sections.changeChoices.title")}</h2>
          ...
          <section className="mb-10">
            <h2 className="!text-[12px] !font-black text-[#1f1f1f]">{bt("sections.browser.title")}</h2>
          ...
          <section className="mb-10">
            <h2 className="!text-[12px] !font-black text-[#1f1f1f]">{bt("sections.contact.title")}</h2>
