        ...
        <div className="rounded-2xl border border-[rgba(0,166,255,0.35)] bg-white px-5 py-8 shadow-[0_16px_48px_rgba(30,64,175,0.09)] backdrop-blur-xl sm:px-8 sm:py-10">
          ...
          <article className={LEGAL_ARTICLE_CLASS}>
            ...
            <section className="mb-10">
              ...
              <div className="mt-6">
                <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>{bt("sections.dataCollected.contractBilling.title")}</h3>
                <BulletList prefix="sections.dataCollected.contractBilling.list" keys={["i1", "i2", "i3", "i4"]} />
              </div>
              <div className="mt-6">
                <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>{bt("sections.dataCollected.contentProject.title")}</h3>
              ...
              <div className="mt-6">
                <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>{bt("sections.dataCollected.logsSecurity.title")}</h3>
            ...
            <section className="mb-10">
              ...
              <div className="mt-6">
                <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>{bt("sections.purposes.platformSecurity.title")}</h3>
              ...
              <div className="mt-6">
                <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>{bt("sections.purposes.legalObligations.title")}</h3>
