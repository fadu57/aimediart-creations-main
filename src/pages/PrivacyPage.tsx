...
import {
  LEGAL_ARTICLE_CLASS,
  LEGAL_SECTION_TITLE_CLASS,
  LEGAL_SUBSECTION_TITLE_CLASS,
} from "@/pages/legalPageStyles";
...
function PrivacyI18nFullDocument() {
  const { t } = useTranslation("privacy");
    ...
    <>
      ...
      <article className={LEGAL_ARTICLE_CLASS}>
        <section className="mb-10">
          <h2 className={LEGAL_SECTION_TITLE_CLASS}>{bt("sections.controller.title")}</h2>
        ...
        <section className="mb-10">
          <h2 className={LEGAL_SECTION_TITLE_CLASS}>{bt("sections.dataCollected.title")}</h2>
          <p className="mt-3">{bt("sections.dataCollected.p1")}</p>

          <div className="mt-6">
            <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>{bt("sections.dataCollected.accountId.title")}</h3>
            <BulletList prefix="sections.dataCollected.accountId.list" keys={["i1", "i2", "i3", "i4"]} />
          </div>
          <div className="mt-6">
            <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>
              {bt("sections.dataCollected.contractBilling.title")}
            </h3>
            <BulletList
              prefix="sections.dataCollected.contractBilling.list"
              keys={["i1", "i2", "i3", "i4"]}
            />
          </div>
          <div className="mt-6">
            <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>
              {bt("sections.dataCollected.contentProject.title")}
            </h3>
          ...
          <div className="mt-6">
            <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>
              {bt("sections.dataCollected.logsSecurity.title")}
            </h3>
            <BulletList prefix="sections.dataCollected.logsSecurity.list" keys={["i1", "i2", "i3"]} />
          </div>
          <div className="mt-6">
            <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>{bt("sections.dataCollected.navigation.title")}</h3>
          ...
          <div className="mt-6">
            <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>{bt("sections.dataCollected.support.title")}</h3>
            <BulletList prefix="sections.dataCollected.support.list" keys={["i1", "i2", "i3"]} />
          </div>
        </section>

        <section className="mb-10">
          <h2 className={LEGAL_SECTION_TITLE_CLASS}>{bt("sections.purposes.title")}</h2>
          <p className="mt-3">{bt("sections.purposes.p1")}</p>

          <div className="mt-6">
            <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>{bt("sections.purposes.accountServices.title")}</h3>
          ...
          <div className="mt-6">
            <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>{bt("sections.purposes.b2bClient.title")}</h3>
          ...
          <div className="mt-6">
            <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>
              {bt("sections.purposes.platformSecurity.title")}
            </h3>
          ...
          <div className="mt-6">
            <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>{bt("sections.purposes.audience.title")}</h3>
          ...
          <div className="mt-6">
            <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>{bt("sections.purposes.communication.title")}</h3>
          ...
          <div className="mt-6">
            <h3 className={LEGAL_SUBSECTION_TITLE_CLASS}>
              {bt("sections.purposes.legalObligations.title")}
            </h3>
        ...
        <section className="mb-10">
          <h2 className={LEGAL_SECTION_TITLE_CLASS}>{bt("sections.recipients.title")}</h2>
        ...
        <section className="mb-10">
          <h2 className={LEGAL_SECTION_TITLE_CLASS}>{bt("sections.transfers.title")}</h2>
        ...
        <section className="mb-10">
          <h2 className={LEGAL_SECTION_TITLE_CLASS}>{bt("sections.rights.title")}</h2>
        ...
        <section className="mb-10">
          <h2 className={LEGAL_SECTION_TITLE_CLASS}>{bt("sections.complaints.title")}</h2>
        ...
        <section className="mb-10">
          <h2 className={LEGAL_SECTION_TITLE_CLASS}>{bt("sections.security.title")}</h2>
        ...
        <section className="mb-10">
          <h2 className={LEGAL_SECTION_TITLE_CLASS}>{bt("sections.processorRole.title")}</h2>
        ...
        <section className="mb-10">
          <h2 className={LEGAL_SECTION_TITLE_CLASS}>{bt("sections.ai.title")}</h2>
        ...
        <section className="mb-10">
          <h2 className={LEGAL_SECTION_TITLE_CLASS}>{bt("sections.thirdPartyLinks.title")}</h2>
...
const PrivacyPage = () => (
  <LegalEditablePage
    slug="privacy"
    contentNamespace="privacy"
    i18nFallback={<PrivacyI18nFullDocument />}
  />
);
