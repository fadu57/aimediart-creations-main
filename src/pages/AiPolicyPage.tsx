        ...
        <div className="rounded-2xl border border-[rgba(0,166,255,0.35)] bg-white px-5 py-8 shadow-[0_16px_48px_rgba(30,64,175,0.09)] backdrop-blur-xl sm:px-8 sm:py-10">
          ...
          <article className="prose prose-neutral mt-8 max-w-none border-0 bg-transparent p-0 shadow-none backdrop-blur-none prose-headings:font-semibold prose-headings:text-[#1f1f1f] [&_blockquote]:!text-[12px] [&_li]:!font-normal [&_li]:!text-[12px] [&_li]:leading-relaxed [&_p]:!text-[12px] [&_p]:leading-relaxed sm:mt-10">
            <section className="mb-10">
              <h2 className="!text-[12px] !font-black text-[#1f1f1f]">{bt("sections.scope.title")}</h2>
              <p className="mt-3">{bt("sections.scope.p1")}</p>
              <p className="mt-3">{bt("sections.scope.p2")}</p>
            </section>

            <section className="mb-10">
              <h2 className="!text-[12px] !font-black text-[#1f1f1f]">{bt("sections.natureLimits.title")}</h2>
              <BulletList prefix="sections.natureLimits.list" keys={["i1", "i2", "i3"]} />
            </section>

            <section className="mb-10">
              <h2 className="!text-[12px] !font-black text-[#1f1f1f]">{bt("sections.editorialResponsibility.title")}</h2>
              <BulletList prefix="sections.editorialResponsibility.list" keys={["i1", "i2", "i3"]} />
            </section>

            <section className="mb-10">
              <h2 className="!text-[12px] !font-black text-[#1f1f1f]">{bt("sections.allowedUses.title")}</h2>
            ...
            <section className="mb-10">
              <h2 className="!text-[12px] !font-black text-[#1f1f1f]">{bt("sections.aiData.title")}</h2>
              <BulletList prefix="sections.aiData.list" keys={["i1", "i2", "i3"]} />
            </section>

            <section className="mb-10">
              <h2 className="!text-[12px] !font-black text-[#1f1f1f]">{bt("sections.regulation.title")}</h2>
