          ...
          <div className="flex shrink-0 items-center gap-3">
            ...
            <div className="inline-flex items-center gap-1 rounded-lg border border-neutral-300/80 bg-white px-2 py-1.5 shadow-sm">
              ...
              <select
                ...
                className="h-6 w-[58px] bg-transparent text-[11px] font-semibold outline-none cursor-pointer"
              ...
              <div className="pt-2 flex flex-col gap-2">
                ...
                <div className="inline-flex items-center gap-2 rounded-lg border border-neutral-200 bg-white px-2.5 py-2">
                  ...
                  <select
                    value={language}
                    onChange={(e) => setLanguage(e.target.value as UiLanguage)}
                    className="h-6 w-full bg-transparent text-sm font-semibold outline-none cursor-pointer"
                    aria-label={t("nav.language_label")}
                  >
                    {UI_LANGUAGE_OPTIONS.map((opt) => (
                      <option key={opt.value} value={opt.value}>{opt.label}</option>
          ...
          <div className="mx-auto w-full max-w-[1060px] px-5 sm:px-6">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-wrap gap-3 text-sm">
                <a href="#contact" className="text-foreground/80 hover:text-foreground">{t("footer.contact")}</a>
                <Link to="/login" className="text-foreground/80 hover:text-foreground">{t("footer.login")}</Link>
              </div>
            </div>
          </div>
        </footer>
