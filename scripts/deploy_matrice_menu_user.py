#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Déploie matrice_securite_add_menu_user.sql (migration 42)."""
...
SQL_PATH = ROOT / "supabase" / "sql" / "matrice_securite_add_menu_user.sql"
...
def main() -> int:
    ...
    print("=== Migration 42 : matrice_securite menu_user ===")
    ...
    if not base_url or not key:
        ...
        print("Sinon : copiez supabase/sql/matrice_securite_add_menu_user.sql dans le SQL Editor Supabase.")
        return 1
    ...
    print("Collez le contenu de supabase/sql/matrice_securite_add_menu_user.sql dans Supabase > SQL Editor.")
    return 1
